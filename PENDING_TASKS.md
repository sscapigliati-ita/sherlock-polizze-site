...
4. **Alta — sicurezza applicativa residua.** Completati rate limit, CSP/security headers e verifica magic-byte. Restano prompt injection/schema AI, retention, cancellazione self-service, CSRF admin e redazione strutturata degli errori.
